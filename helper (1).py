...
#This function is for online event
# def create_online_google_calendar_event(service, event_details):
#     from uuid import uuid4
#     event = {
#         'summary': event_details['summary'],
#         'location': event_details['location'],
...
#     }
    ...
    try:
        event = service.events().insert(
            calendarId='primary', 
            body=event, 
            sendUpdates='all',  # Ensure updates are sent to all attendees
